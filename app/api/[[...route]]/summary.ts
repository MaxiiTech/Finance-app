...
import { zValidator } from '@/node_modules/@hono/zod-validator/dist/esm/index';
import { Hono } from "hono";
import { z } from "zod";
import { sql, sum, eq, desc, and, gte, lte, lt } from "drizzle-orm";
        ...
        async (c) => {
            ...
            return c.json({
                data: {
                    ...
                    expensesAmount: currentPeriod.expenses, expensesChange,
